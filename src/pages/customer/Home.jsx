        ...
        <div className="w-full px-4 sm:px-8 xl:px-16 py-10 max-w-[1700px] mx-auto space-y-16 fade-in relative z-10">
          ...
          <div className="flex items-center gap-3 overflow-x-auto pb-4 no-scrollbar">
            <button
              ...
              className={`px-8 py-3 rounded-full font-black text-xs uppercase tracking-widest transition-all whitespace-nowrap ${selectedCategory === "all"
            ...
            {categories.map((cat) => (
              <button
                ...
                className={`px-8 py-3 rounded-full font-black text-xs uppercase tracking-widest transition-all whitespace-nowrap border ${selectedCategory === cat._id
                ...
                filteredShops.map((shop) => (
                  <Link key={shop._id} to={`/shops/${shop._id}`} className="glass-card p-6 flex items-center gap-6 group hover:border-lavender hover:shadow-2xl hover:shadow-lavender/10 transition-all border-white/80">
                    <div className="w-24 h-24 rounded-3xl overflow-hidden shadow-xl bg-slate-50 flex-shrink-0 relative">
                      <img
                        src={shop.logo || `https://images.unsplash.com/photo-1521590832167-7bcbfaa6381f?auto=format&fit=crop&w=200&q=80`}
